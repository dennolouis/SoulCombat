...
//////////////////////////////////////////////////////////////////////////
// ASoulCombatCharacter

ASoulCombatCharacter::ASoulCombatCharacter()
{
...
void ASoulCombatCharacter::NotifyControllerChanged()
{
...
void ASoulCombatCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ASoulCombatCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ASoulCombatCharacter::Look);
	}
	else
	{
...
void ASoulCombatCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
